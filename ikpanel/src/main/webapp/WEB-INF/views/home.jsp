...
<body>
  ...
  <div style="position: fixed; bottom: 0px; padding-left: 60px"> <p align=center id="dateDemo"></p> </div>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div>
          <br>
          <h5 class="fh5co-article-title animate-box">İş Ünvanı</h5>
        <textarea class="form form-control" id="is_unvan" style="height: 40px; width: 40%"></textarea>
        <br>
        <h5 class="fh5co-article-title animate-box">İş Tanımı</h5>
        <textarea class="form form-control" id="is_tanim" style="height: 100px;width: 60%"></textarea>
        <br>
        <h5 class="fh5co-article-title animate-box">İşe Alınacak Kişi Sayısı</h5>
        <textarea class="form form-control" id="is_kisi" style="height: 40px; width: 20%"></textarea>
        <br>
        <h5 class="fh5co-article-title animate-box">Son Başvuru Tarihi</h5>
        <textarea class="form form-control" id="is_tarih" style="height: 40px; width: 20%"></textarea>
        <br>
        <button class="btn btn-success" onclick="addJob()">Kaydet</button>
  ...
  <script src="custom/indeks.js"></script>
