...
<body>
  ...
  <div style="position: fixed; bottom: 0px; padding-left: 60px"> <p align=center id="dateDemo2"></p> </div>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
  ...
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script src="custom/ilancekme.js"></script>
  <!-- Menu Toggle Script -->
  <script>
...
document.getElementById("dateDemo2").innerHTML = d.getDate()+" "+months[d.getMonth()]+" "+d.getFullYear();  
</script>
