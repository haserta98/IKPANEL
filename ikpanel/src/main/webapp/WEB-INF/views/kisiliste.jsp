...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="ilanliste" class="list-group-item list-group-item-action bg-light" >İş İlanları</a>
  ...
  <div style="position: fixed; bottom: 0px; padding-left: 60px"> <p align=center id="dateDemo3"></p> </div>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
  ...
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script src="custom/kisilistesi.js"></script>
  <!-- Menu Toggle Script -->
  <script>
...
document.getElementById("dateDemo3").innerHTML = d.getDate()+" "+months[d.getMonth()]+" "+d.getFullYear();  
</script>
